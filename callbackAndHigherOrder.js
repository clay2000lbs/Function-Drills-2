...
const contains = (arr, nameString, callback) => (arr.includes(nameString) ? callback(true) : callback(false))
...
// CODE HERE
const recall = UNIQARRPARAM => `The new names array with all the duplicate items removed is ${UNIQARRPARAM}.`
console.log(uniq(names, recall))
